...
<body>
	<div class="container div-margin-bottom">
		...
		<div class="table-responsive">
			...
			<div style="width: 100%; text-align:center"><input type="button" value="삭제" onclick="location.href='${pageContext.request.contextPath}/main.do?action=deleteNotice&title=${noticeDetail.title}'"></div>
		</div>
	</div>
</body>
</html>